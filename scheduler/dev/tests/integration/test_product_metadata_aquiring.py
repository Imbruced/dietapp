...
class TestProductMetaDataAquire:
    ...
    __expected_products = [
        sample_product_metadata.copy(
            url="https://www.carrefour.pl/mleko-nabial-jaja/sery/sery-salatkowe-kanapkowe/bieluch-serek"
        ),
        sample_product_metadata.copy(
            url="https://www.carrefour.pl/mleko-nabial-jaja/twarog-serek-wiejski/serki-wiejskie/mlekovita-polski-wiejski"
        ),
        sample_product_metadata.copy(
            url="https://www.carrefour.pl/mleko-nabial-jaja/twarog-poltlusty-275-g"
        ),
        sample_product_metadata.copy(
            url="https://www.carrefour.pl/mleko-nabial-jaja/sery/ser-120-g"
        ),
        sample_product_metadata.copy(
            url="https://www.carrefour.pl/mleko-nabial-jaja/mleczny-przystanek-twarog-chudy-250-g"
        ),
        sample_product_metadata.copy(
            url="https://www.carrefour.pl/mleko-nabial-jaja/carrefour-ser-dziuramer-150-g"
        )
